...
export const mockData = {
    board: {
      _id: 'board-id-01',
      title: 'Nguyen Quang Hai',
      description: 'Trello Project Test',
      type: 'public', // 'private'
      ...
      columns: [
          ...
          cards: [
            {
              ...
              cover: 'https://images.pexels.com/photos/1174122/pexels-photo-1174122.jpeg?auto=compress&cs=tinysrgb&w=1600',
        ...
        },
        {
          ...
          cards: [
            { _id: 'card-id-06', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 06', description: null, cover: null, memberIds: [], comments: [], attachments: [] },
            { _id: 'card-id-07', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 07', description: null, cover: null, memberIds: [], comments: [], attachments: [] },
